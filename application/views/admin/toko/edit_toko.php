          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <ul class="page_info" >          
                    ...
                    <form  method="POST" id="form_input_toko" action="<?= base_url() ?>toko/edit" enctype="multipart/form-data">                     
                    <?php
                     foreach ($toko as $k) {
                       ?>
                       <div class="row-fluid">
                        ...
                        <div class="span9">
                          <input required="" id="nama_toko" type="text" size="40" name="nama_toko" value="<?= $k->nama_toko ?>" />*
                          <i id="kat_error" style="display:none;color:red">kode toko sudah ada</i>
                        </div> 
                      </div> 
                      <div class="row-fluid">
                       ...
                       <div>
                        ...
                        <div class="span9"><input required="" value="<?= $k->pemilik ?>" id="pemilik" type="text" size="40" name="pemilik" />*</div> 
                      </div>
                       <?php
                     }
                    ?>
