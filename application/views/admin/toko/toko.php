          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <ul class="breadcrumb br_styled no_space">
                ...
                <li class="active"><a href="<?= base_url() ?>toko">toko</a></li>
              </ul> 
              <ul class="page_info" >
              <div id="tabel_tas">
              <li><h2 style='text-align:center'>Tabel Daftar Toko</h2></li>
              <a href="<?= base_url() ?>toko/tambah_toko" id="tambah_tas">
                            ...
                            foreach ($toko as $k) {
                               echo "
                                         <tr class='gradeC' id='baris-$no'>
                                          <input type='hidden' value='".$k->id_toko."' id='hapus-$no' />
                                          <td style='text-align:center'>".$no."</td>
                                          <td>".$k->nama_toko."</td>                                    
                                          <td>".$k->alamat."</td>                                          
                                          <td>".$k->pemilik."</td>   
                                          <td class='center'>
                                            <a href='".base_url()."toko/edit/".$k->id_toko."' title='haput'>
    ...
    <script type="text/javascript">
     ...
     $(document).ready(function(){
       ...
       /* $(".hapus").click(function(){
         var r = confirm("apakah yakin data ini mau di hapus ?");
            if (r==true){
               //window.location="<?= base_url().'toko/hapus' ?>";
               window.href();
            }
         return false;
        });*/
