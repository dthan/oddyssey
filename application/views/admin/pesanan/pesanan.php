          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <ul class="breadcrumb br_styled no_space">
                ...
                <li class="active"><a href="<?= base_url() ?>pesanan">pesanan</a></li>
              </ul> 
              <ul class="page_info" >
              <div id="tabel_tas">
              <li><h2 style='text-align:center'>Tabel pesanan Tas</h2></li>
              <a href="<?= base_url() ?>pesanan/tambah_pesanan" id="tambah_tas">
              ...
              <section class="group" style="margin-top:5px">                         
                           ...
                           <?php
                            ...
                            foreach ($pesanan as $k) {
                               echo "
                                         ...
                                         <input type='hidden' value='".$k->kode_transaksi."' id='hapus-$no' />
                                          ...
                                          <td class='center'>
                                             <a class='hapus' href='".base_url()."pesanan/cetak_faktur/".$k->kode_transaksi."' target='blank' title='hapus'>
                                              <img src='".base_url()."asset/print.png' width='16'/>cetak
                                            </a>
                                            <a href='".base_url()."pesanan/edit/".$k->kode_transaksi."' title='hapus'>
                    ...
                    <form style="display:none" method="POST" id="form_input_pesanan" action="<?= base_url() ?>pesanan/tambah" enctype="multipart/form-data">                     
                      <div class="row-fluid">
                        <div class="span3">Nama pesanan:</div>
                        <div class="span9"><input type="text" size="40" name="nama_pesanan" />*</div> 
                      </div>  
                       <div class="row-fluid">
    ...
    function hapus(i){
       var r = confirm("apakah yakin data ini mau di hapus ?");
            if (r==true){
                ...
                $.ajax({
                        type:'POST',
                        url:'<?= base_url() ?>pesanan/hapus/'+kode,
     ...
     $(document).ready(function(){
       ...
       /* $(".hapus").click(function(){
         var r = confirm("apakah yakin data ini mau di hapus ?");
            if (r==true){
               //window.location="<?= base_url().'pesanan/hapus' ?>";
               window.href();
            }
         return false;
        });*/
