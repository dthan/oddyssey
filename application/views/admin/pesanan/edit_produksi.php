          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              foreach ($produksi as $k) {
                ?>
                 <form  method="POST" id="form_edit_produksi" action="<?= base_url() ?>produksi/aksi_edit" enctype="multipart/form-data">                     
                      <div class="row-fluid">
                        <div class="span3">Nama Barang:</div>
                        <div class="span9">
                        <input type="hidden" name="id_produksi" value="<?= $k->id_produksi ?>">
                        <input required="" type="text" size="40" name="nama_produksi" value="<?= $k->nama_barang ?>" />*</div> 
                      </div>  
                       <div class="row-fluid">
                          <div class="span3">Tempat produksi:</div>
                          <div class="span9">
                             <?= form_dropdown('maklun', $maklun,  $k->id_maklun, 'id="kategori" required=""') ?>                        
                          </div>
                        </div>  
                        <div class="row-fluid">
                           <div class="span3">jumlah produksi :</div>
                           <div class="span9"><input required="" type="text" size="40" name="jumlah_produksi" value="<?= $k->jumlah_produksi ?>" /></div>
                        </div>      
                        <div id="form_atribut">
                        <?php
                          $x=1;
                          ...
                          <?php
                                  ...
                                  foreach ($atribut->result() as $g) {
                                    ...
                                    <div class="row-fluid">
                                       ...
                                       <div class="span9">
                                          nama <input type="text" name="atribut-<?= $x ?>" style="width:150px" value="<?= $g->nama_atribut ?>" />
                                          Harga<input type="text" name="harga-<?= $x ?>" style="width:100px"  value="<?= $g->harga ?>"/>
                                          jumlah<input type="text" name="jumlah-<?= $x ?>" style="width:50px"  value="<?= $g->jumlah ?>"/>&nbsp;&nbsp; 
                                          <input type="hidden" name="id_atribut-<?= $x ?>" value="<?= $g->id_atribut ?>">                            
                                       <?php 
                                       if($x==1){
                                       ?>
                                         <a href="#" id="tambah_atribut"><img  src="<?= base_url() ?>asset/admin/img/add.png" />tambah atribut</a>
                                       <?php }
                                       ?>
                                       </div>
