                    ...
                    <form  method="POST" id="form_input_produk" action="<?= base_url() ?>produk/tambah" enctype="multipart/form-data">                     
                      <div class="row-fluid">
                       ...
                       <div class="row-fluid">
                          ...
                          <div class="span9">
                             <?= form_dropdown('kategori', $kategori,  '', 'id="kategori" required=""') ?>                        
                          </div>
                        </div>  
                        <div class="row-fluid">
                           <div class="span3">harga grosir:</div>
                           <div class="span9"><input required="" type="text" size="40" name="harga" /></div>
                        </div> 
                        <div class="row-fluid">
                           <div class="span3">harga eceran:</div>
                           <div class="span9">
                             <input required="" type="text" size="40" name="harga_eceran" />
                             minimal pembelian :
                             <input required="" type="text" size="20" name="minimal" style="width:50px" />
                           </div>
                        </div> 
                         <div class="row-fluid">
                           <div class="span3">Stok:</div>
                           <div class="span9"><input required="" type="text" size="40" name="stok" /></div>
                        </div> 
                         <div class="row-fluid">
                           <div class="span3">Diskon:</div>
                           <div class="span9"><input type="text" size="40" name="diskon" />%</div>
                        </div> 
                        <div class="row-fluid">
                           <div class="span3">keterangan</div>
                           <div class="span9"><textarea id="cleeditor" name="ket"></textarea></div>
                        </div> 
                        <div id="form_upload">
                            <div class="row-fluid">
