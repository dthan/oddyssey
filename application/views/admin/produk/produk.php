          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <ul class="breadcrumb br_styled no_space">
                ...
                <li class="active"><a href="<?= base_url() ?>produk">Produk</a></li>
              </ul> 
              <ul class="page_info" >
              <div id="tabel_tas">
              <li><h2 style='text-align:center'>Tabel Produk Tas</h2></li>
              <a href="<?= base_url() ?>produk/tambah_produk" id="tambah_tas">
              ...
              <section class="group" style="margin-top:5px">                         
                       <table id="example" cellpadding="0" cellspacing="0" border="0" class="display" >
                          <thead>
                              <tr>
                                  ...
                                  <th style='text-align:center'>Kode Tas</th>
                           ...
                           <?php
                            ...
                            foreach ($produk as $k) {
                               echo "
                                         ...
                                         <input type='hidden' value='".$k->id_produk."' id='hapus-$no' />
                                          <td style='text-align:center'>".$no."</td>
                                          <td>".$k->id_produk."</td>
                                          <td>".$k->nama_produk."</td>
                                          <td>".$k->nama_kategori."</td>
                                          <td class='center'>".$k->stok."</td>
                                          <td class='center'>Rp. ".number_format($k->harga,0)."</td>
                                          <td class='center'>
                                            <a href='".base_url()."produk/edit/".$k->id_produk."' title='haput'>
                    ...
                    <form style="display:none" method="POST" id="form_input_produk" action="<?= base_url() ?>produk/tambah" enctype="multipart/form-data">                     
                      <div class="row-fluid">
                        <div class="span3">Nama Produk:</div>
                        <div class="span9"><input type="text" size="40" name="nama_produk" />*</div> 
                      </div>  
                       <div class="row-fluid">
    ...
    function hapus(i){
       var r = confirm("apakah yakin data ini mau di hapus ?");
            if (r==true){
                ...
                $.ajax({
                        type:'POST',
                        url:'<?= base_url() ?>produk/hapus/'+kode,
     ...
     $(document).ready(function(){
       ...
       /* $(".hapus").click(function(){
         var r = confirm("apakah yakin data ini mau di hapus ?");
            if (r==true){
               //window.location="<?= base_url().'produk/hapus' ?>";
               window.href();
            }
         return false;
        });*/
