...
<html lang="en">
  ...
  foreach ($produksi as $key) {
    echo "
          ...
          <a target='blank' href='".base_url()."produksi/cetak_faktur/".$key->id_produksi."'  title='detail'><img src='".base_url()."asset/print.png' width='25'/>cetak faktur
         </a> || 
         <a href='".base_url()."produksi/edit/".$key->id_produksi."' title='haput'><img src='".base_url()."asset/admin/img/edit.png' width='25' />edit
         </a>                                           
         </div>
         ";
  ?>
