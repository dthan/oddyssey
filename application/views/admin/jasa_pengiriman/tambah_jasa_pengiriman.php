          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <ul class="breadcrumb br_styled no_space">
                ...
                <li><a href="<?= base_url() ?>jasa_pengiriman">jasa_pengiriman</a></li><span class="divider">/</span>
                <li class="active">Tambah jasa pengiriman</li>
              </ul> 
              <ul class="page_info" >
          
                                    
                    <form  method="POST" id="form_input_jasa_pengiriman" action="<?= base_url() ?>jasa_pengiriman/tambah" enctype="multipart/form-data">                     
                     
                      <div class="row-fluid">
                        <div class="span3">Nama jasa pengiriman:</div>
                        <div class="span9"><input required="" id="nama_jasa_pengiriman" type="text" size="40" name="nama_jasa_pengiriman" />*</div> 
                      </div>  
                       <div class="row-fluid">
    ...
    <script type="text/javascript">
     $(document).ready(function(){   
       ...
       /*  $("#form_input_jasa_pengiriman").submit(function(){
            ...
            $.ajax({
                        type:'POST',
                        url:'<?= base_url() ?>jasa_pengiriman/tambah',
                        ...
                        success: function(msg)
                        {
                           if(msg=="sukses"){
                              $('#gagal').hide();
                              $('#sukses').show();
                              document.location="<?= base_url() ?>jasa_pengiriman ";
                              //$("#kode_jasa_pengiriman").val('');
                              //$("#nama_jasa_pengiriman").val('');
                            }
                            else{
                              $('#sukses').hide();
                              $('#gagal').show();
