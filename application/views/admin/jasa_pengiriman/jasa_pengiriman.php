          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <ul class="breadcrumb br_styled no_space">
                ...
                <li class="active"><a href="<?= base_url() ?>jasa_pengiriman">jasa pengiriman</a></li>
              </ul> 
              <ul class="page_info" >
              <div id="tabel_tas">
              <li><h2 style='text-align:center'>Tabel jasa pengiriman</h2></li>
              <a href="<?= base_url() ?>jasa_pengiriman/tambah_jasa_pengiriman" id="tambah_tas">
                            ...
                            foreach ($jasa_pengiriman as $k) {
                               echo "
                                         <tr class='gradeC' id='baris-$no'>
                                          <input type='hidden' value='".$k->id_jasa_pengiriman."' id='hapus-$no' />
                                          <td style='text-align:center'>".$no."</td>
                                          <td>".$k->nama_jasa_pengiriman."</td>                                    
                                          <td><img src='".base_url()."gambar_jasa_pengiriman/".$k->logo."' width='100' /></td>                                          
                                          <td class='center'>
                                            <a href='".base_url()."jasa_pengiriman/edit/".$k->id_jasa_pengiriman."' title='haput'>
    ...
    <script type="text/javascript">
     function hapus(i){
       var r = confirm("apakah yakin data ini mau di hapus ? ");
            if (r==true){
                ...
                $.ajax({
                        type:'POST',
                        url:'<?= base_url() ?>jasa_pengiriman/hapus/'+kode,
     ...
     $(document).ready(function(){
       ...
       /* $(".hapus").click(function(){
         var r = confirm("apakah yakin data ini mau di hapus ?");
            if (r==true){
               //window.location="<?= base_url().'jasa_pengiriman/hapus' ?>";
               window.href();
            }
         return false;
        });*/
