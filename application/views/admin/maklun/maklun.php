          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <ul class="breadcrumb br_styled no_space">
                ...
                <li class="active"><a href="<?= base_url() ?>maklun">maklun</a></li>
              </ul> 
              <ul class="page_info" >
              <div id="tabel_tas">
              <li><h2 style='text-align:center'>Tabel maklun Tas</h2></li>
              <a href="<?= base_url() ?>maklun/tambah_maklun" id="tambah_tas">
                       ...
                       <table id="example" cellpadding="0" cellspacing="0" border="0" class="display" >
                          <thead>
                              <tr>
                                  ...
                                  <th style='text-align:center'>Nama maklun</th>  
                            ...
                            foreach ($maklun as $k) {
                               echo "
                                         <tr class='gradeC' id='baris-$no'>
                                          <input type='hidden' value='".$k->id_maklun."' id='hapus-$no' />
                                          <td style='text-align:center'>".$no."</td>
                                          <td>".$k->nama_maklun."</td>                                    
                                          <td>".$k->alamat."</td>                                          
                                          <td class='center'>
                                            <a href='".base_url()."maklun/edit/".$k->id_maklun."' title='haput'>
...
eget, pretium porttitor quam. Sed varius vulputate lacinia. </li>
    ...
    <script type="text/javascript">
     function hapus(i){
       var r = confirm("apakah yakin data ini mau di hapus ?  jika data ini di hapus maka data di produksi yang tempat produksi maklun nya ini akan iku terhapus");
            if (r==true){
                
                var kode = $("#hapus-"+i).val();
                $.ajax({
                        type:'POST',
                        url:'<?= base_url() ?>maklun/hapus/'+kode,
     ...
     $(document).ready(function(){
       ...
       /* $(".hapus").click(function(){
         var r = confirm("apakah yakin data ini mau di hapus ?");
            if (r==true){
               //window.location="<?= base_url().'maklun/hapus' ?>";
               window.href();
            }
         return false;
        });*/
