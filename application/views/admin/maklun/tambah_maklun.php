          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <ul class="breadcrumb br_styled no_space">
                ...
                <li class="active">Tambah maklun</li>
              </ul> 
              <ul class="page_info" >
          
                                    
                    <form  method="POST" id="form_input_maklun" action="<?= base_url() ?>maklun/tambah" enctype="multipart/form-data">                     
                     
                      <div class="row-fluid">
                        <div class="span3">Nama maklun:</div>
                        <div class="span9"><input required="" id="nama_maklun" type="text" size="40" name="nama_maklun" />*</div> 
                      </div>  
                       <div class="row-fluid">
            ...
            $.ajax({
                        ...
                        success: function(msg)
                        {
                           if(msg=="sukses"){
                              $('#gagal').hide();
                              $('#sukses').show();
                              document.location="<?= base_url() ?>maklun ";
                              //$("#kode_maklun").val('');
                              //$("#nama_maklun").val('');
                            }
                            else{
