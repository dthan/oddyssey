          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <ul class="page_info" >
                    ...
                    <form  method="POST" id="form_input_kategori" action="<?= base_url() ?>kategori/tambah" enctype="multipart/form-data">                     
                      <div class="row-fluid">
                        <div class="span3">Kode kategori:</div>
                        <div class="span9">
                          <input required="" id="kode_kategori" type="text" size="40" name="kode_kategori" />*
                          <i id="kat_error" style="display:none;color:red">kode kategori sudah ada</i>
                        </div> 
                      </div> 
                      <div class="row-fluid">
                        <div class="span3">Nama kategori:</div>
                        <div class="span9"><input required="" id="nama_kategori" type="text" size="40" name="nama_kategori" />*</div> 
                      </div>  
            ...
            $.ajax({
                        ...
                        success: function(msg)
                        {
                           if(msg=="sukses"){
                              $('#gagal').hide();
                              $('#sukses').show();
                              document.location="<?= base_url() ?>kategori ";
                              //$("#kode_kategori").val('');
                              //$("#nama_kategori").val('');
                            }
                            else{
