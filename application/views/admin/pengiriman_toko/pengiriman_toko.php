          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <ul class="breadcrumb br_styled no_space">
                ...
                <li class="active"><a href="<?= base_url() ?>pengiriman_toko">pengiriman_toko</a></li>
              </ul> 
              <ul class="page_info" >
              <div id="tabel_tas">
              <li><h2 style='text-align:center'>Tabel Daftar Pengiriman Toko</h2></li>
              <a href="<?= base_url() ?>pengiriman_toko/tambah_pengiriman_toko" id="tambah_tas">
                       ...
                       <table id="example" cellpadding="0" cellspacing="0" border="0" class="display" >
                          <thead>
                              <tr>
                                  ...
                                  <th style='text-align:center'>cetak faktur</th>
                            ...
                            foreach ($pengiriman_toko as $k) {
                               echo "
                                         <tr class='gradeC' id='baris-$no'>
                                          <input type='hidden' value='".$k->kode_pengiriman."' id='hapus-$no' />
                                          <td style='text-align:center'>".$no."</td>
                                          <td>".$k->nama_toko."</td>                                    
                                          <td>".$k->alamat_penerima."</td>                                          
                                          <td>".$k->pemilik."</td>   
                                          <td>".$k->kurir."</td>   
                                          <td>".$this->tanggal->tgl_indo($k->tgl_pengiriman)."</td>"; 
                                          if($k->cetak_faktur=='T'){
                                            echo "<td id='baris_cetak-'".$no." style='background-color:#ffa07a;text-align:center'>belum</td> ";
                                          }
                                          else{
                                            echo "<td>sudah</td>"; 
                                          }
                                          echo "
                                          <td class='center'>
                                          <a class='cetak' href='".base_url()."pengiriman_toko/cetak_faktur/".$k->kode_pengiriman."' target='blank' title='hapus'>
                                              <img src='".base_url()."asset/print.png' width='16'/>cetak
                                            </a>
                                            <a href='".base_url()."pengiriman_toko/edit/".$k->kode_pengiriman."' title='haput'>
    ...
    <script type="text/javascript">
     function hapus(i){
       var r = confirm("apakah yakin data ini mau di hapus ? ");
            if (r==true){
                ...
                $.ajax({
                        type:'POST',
                        url:'<?= base_url() ?>pengiriman_toko/hapus/'+kode,
     ...
     $(document).ready(function(){
       ...
       $(".cetak").click(function(){
          $('#baris_cetak-1').css({ "background-color": "white" });
